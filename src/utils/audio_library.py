...
# Set COQUI_AVAILABLE
COQUI_AVAILABLE = False  # We'll set this manually for now

# Check if Coqui is available
try:
    from scripts.coqui_transcriber import transcribe_audio as coqui_transcribe
...
class AudioLibrary:
    def __init__(self, option, **kwargs):
        ...
        :param option: A string indicating which library to use. Acceptable values:
            "whisper", "deepgram", "google", "azure", "deepspeech", "coqui", "vosk".
        ...
        if self.option == "whisper":
            ...
            raise ValueError("Unsupported library option. Choose one of: whisper, deepgram, google, azure, deepspeech, vosk, or coqui (if installed).")
